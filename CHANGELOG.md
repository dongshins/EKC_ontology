...
### Documentation 
- **Detailed dossier:** [`docs/changes/v2025.1.0-ontology-revision.md`](https://github.com/dongshins/EKC_ontology/blob/main/docs/changes/v2025.1.0-ontology-revision.md) <!--(**continuously updated with incremental additions**)--> 
