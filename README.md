...
It has been **developed** since 2016 during the Encyclopedic Archives of Korean Culture digitization project at [**the Center for Digital Humanities** in **the Academy of Korean Studies**](https://dh.aks.ac.kr/) and refined through various digital humanities projects there. 
...
Current version: EKC 2025 [v2025.0.0]
...
The present specification is based on the document "[Ontology:EKC 2022](https://dh.aks.ac.kr/~hanyang2/wiki/index.php/Ontology:EKC_2022)", originally led by [**Hyeon KIM (김현 @ko; Professor, AKS)**](http://www.xuanflute.com/) in the Center for Digital Humanities at the Academy of Korean Studies.
...
This version is preserved for reproducibility,
...
-->
- 구체적인 내역은 [CONTRIBUTORS.md](./CONTRIBUTORS.md)를 참고해 주십시오.
